...
public class DeleteBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("Prompt Semibold", 0, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Enter The ID Book");

        txtID.setFont(new java.awt.Font("Prompt Semibold", 0, 12)); // NOI18N

        btnDelete.setBackground(new java.awt.Color(0, 153, 255));
        btnDelete.setFont(new java.awt.Font("Prompt Semibold", 0, 12)); // NOI18N
