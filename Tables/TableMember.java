...
public class TableMember extends javax.swing.JFrame {

    /**
     * Creates new form TableMember
     */
    public TableMember() {
        initComponents();
        Connect();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableMember.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
